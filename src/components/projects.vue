<template>
    <div class="p-0 m-0 d-flex flex-column align-items-stretch section overflow-hidden position-relative">
...
.title {
    font-size: clamp(32px, 2.75vw, 48px);
    font-weight: 900;
}
.title-2 {
    color: #ccc;
